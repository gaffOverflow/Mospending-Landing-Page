import "../App.css";
import rainDrop from "../assets/raindrop-bottom.svg";
    ...
    <>
      <div className="features-container">
        ...
        <section className="flex flex-col gap-4">
          ...
          <aside className="flex flex-col gap-4 bg-gradient-to-b from-[#F5EBFA] from-[54.69%] to-[#EBF5FF] to-100% p-4 rounded-lg">
            ...
            <div className="bg-white w-32 h-32 rounded-full grid place-content-center">
          ...
          <aside className="flex flex-col gap-4 bg-gradient-to-b from-[#F5EBFA] from-[54.69%] to-[#EBF5FF] to-100% p-4 rounded-lg">
            ...
            <div className="flex flex-col justify-center items-center bg-white gap-4 rounded-lg p-2 w-1/2">
        ...
        <section className="grid gap-4 mt-28 ">
          <div className="">
        ...
        <section>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-Primary-Background p-4 rounded-xl">
              ...
              <div>
                <div>
                  ...
                  <p>$</p>
                  <div>5995 7474 1103 7513 0014</div>
                  <div></div>
                </div>
              </div>
            </div>
